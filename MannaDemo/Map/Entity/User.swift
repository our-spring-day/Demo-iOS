...
struct UserModel {
    static var userList: [String : User] = [
        ...
        "aed64e8da3a07df4" : User(id: "2", state: false, profileImage: #imageLiteral(resourceName: "disconnect"), disconnectProfileImage: #imageLiteral(resourceName: "invalid2"), anotherdisconnectProfileImage: #imageLiteral(resourceName: "invalid1"), nicknameImage: #imageLiteral(resourceName: "연재"), latitude: 0, longitude: 0, remainDistance: 0, ranking: 0, networkValidTime: 0, remainTime: 9999999999, arrived: false),
        ...
        "69751764-A224-4923-9844-C61646743D10" : User(id: "8", state: false, profileImage: #imageLiteral(resourceName: "규리img"), disconnectProfileImage: #imageLiteral(resourceName: "invalid2"), anotherdisconnectProfileImage: #imageLiteral(resourceName: "invalid1"), nicknameImage: #imageLiteral(resourceName: "종찬"), latitude: 0
                                                      , longitude: 0, remainDistance: 100, ranking: 0, networkValidTime: 0, remainTime: 9999999999, arrived: false)
    ]
